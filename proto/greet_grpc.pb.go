...
const (
	...
	GreetService_SayHelloServerStreaming_FullMethodName       = "/greet.GreetService/SayHelloServerStreaming"
	GreetService_SayHelloClientStreaming_FullMethodName       = "/greet.GreetService/SayHelloClientStreaming"
	GreetService_SayHelloBidirectonalStreaming_FullMethodName = "/greet.GreetService/SayHelloBidirectonalStreaming"
)
...
type GreetServiceClient interface {
	...
	SayHelloBidirectonalStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error)
}
...
func (c *greetServiceClient) SayHelloBidirectonalStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_SayHelloBidirectonalStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBidirectonalStreamingClient = grpc.BidiStreamingClient[HelloRequest, HelloResponse]
...
type GreetServiceServer interface {
	...
	SayHelloBidirectonalStreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error
...
func (UnimplementedGreetServiceServer) SayHelloBidirectonalStreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBidirectonalStreaming not implemented")
}
...
func _GreetService_SayHelloBidirectonalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBidirectonalStreaming(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBidirectonalStreamingServer = grpc.BidiStreamingServer[HelloRequest, HelloResponse]
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBidirectonalStreaming",
			Handler:       _GreetService_SayHelloBidirectonalStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
